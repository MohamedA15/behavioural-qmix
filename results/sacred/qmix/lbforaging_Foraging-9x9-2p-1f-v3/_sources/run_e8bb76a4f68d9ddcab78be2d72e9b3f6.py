...
def run(_run, _config, _log):
    ...
    unique_token = f"{_config['name']}_seed{_config['seed']}_{map_name}_{timestamp}"
    ...
    # Windows fix:
    # Disabled shutdown print/thread cleanup block because Sacred output capture
    # can raise OSError: [WinError 1] Incorrect function on Windows.
    return
